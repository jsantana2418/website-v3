...
var number1 = prompt("Pick a number between 6 and 10?");
var number2 = prompt("Pick a number between 1 and 5?");
var input1 = parseInt(number1);
var input2 = parseInt(number2);
var randomNumber = Math.floor(Math.random() * (input1 - input2) ) + 1;
alert("Here's a random number from your first selection " + randomNumber);
